...
#include "rust/cxx.h"
#include "gmserverplugin_test/src/lib.rs.h"

#include <iserverplugin.h>
#include <cstdio>
#include <cstring>

class GLuaPackPlugin : public IServerPluginCallbacks
{
public:
	GLuaPackPlugin();
	~GLuaPackPlugin();
	...
	virtual const char     *GetPluginDescription(void) { return "gmserverplugintest"; };
